...
export const OrderDetails = ({ order, onDeliveryCreated, onBack }: OrderDetailsProps) => {
  ...
  if (!order) {
    return (
      <div className="flex flex-col items-center justify-center text-slate-400 bg-slate-50/50 rounded-3xl border-2 border-dashed border-slate-200 p-12 text-center min-h-[500px]">
  ...
  return (
    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm" dir="rtl">
